...
public final class IntSortingNetwork {
    ...
    private static final Comparison COMPARISON_8_1 =
            createComparison(SPECIES_8, new Cmp(0, 2), new Cmp(1, 3), new Cmp(4, 6), new Cmp(5, 7));
    ...
    private static final Comparison COMPARISON_8_2 =
            createComparison(SPECIES_8, new Cmp(0, 4), new Cmp(1, 5), new Cmp(2, 6), new Cmp(3, 7));
    ...
    private static final Comparison COMPARISON_8_3 =
            createComparison(SPECIES_8, new Cmp(0, 1), new Cmp(2, 3), new Cmp(4, 5), new Cmp(6, 7));
    ...
    private static final Comparison COMPARISON_8_5 = createComparison(SPECIES_8, new Cmp(1, 4), new Cmp(3, 6));
    ...
    private static final Comparison COMPARISON_8_6 =
            createComparison(SPECIES_8, new Cmp(1, 2), new Cmp(3, 4), new Cmp(5, 6));
    private static final VectorShuffle<Integer> COMPARISON_8_6_S = COMPARISON_8_6.shuffle;
    private static final VectorMask<Integer> COMPARISON_8_6_M = COMPARISON_8_6.mask;
    ...
    public static void sort8(int[] array, int from) {
        ...
        IntVector vector15 = v5.rearrange(COMPARISON_8_6_S);
        IntVector v6 = v5.min(vector15).blend(v5.max(vector15), COMPARISON_8_6_M);
        v6.intoArray(array, from);
    }

    private static final VectorSpecies<Integer> SPECIES_16 = IntVector.SPECIES_512;

    private static final Comparison COMPARISON_16_1 = createComparison(
            SPECIES_16,
            new Cmp(0, 15),
            new Cmp(1, 14),
            new Cmp(2, 13),
    ...
    private static final Comparison COMPARISON_16_2 = createComparison(
            SPECIES_16,
            new Cmp(0, 7),
            new Cmp(1, 6),
            new Cmp(2, 5),
    ...
    private static final Comparison COMPARISON_16_3 = createComparison(
            SPECIES_16,
            new Cmp(0, 3),
            new Cmp(1, 2),
            new Cmp(4, 7),
    ...
    private static final Comparison COMPARISON_16_4 = createComparison(
            SPECIES_16,
            new Cmp(0, 1),
            new Cmp(2, 8),
            new Cmp(10, 11),
    ...
    private static final Comparison COMPARISON_16_5 = createComparison(
            SPECIES_16,
            new Cmp(1, 4),
            new Cmp(5, 10),
            new Cmp(11, 14),
    ...
    private static final Comparison COMPARISON_16_6 = createComparison(
            SPECIES_16, new Cmp(1, 2), new Cmp(3, 4), new Cmp(6, 7), new Cmp(8, 9), new Cmp(11, 12), new Cmp(13, 14));
    ...
    private static final Comparison COMPARISON_16_7 =
            createComparison(SPECIES_16, new Cmp(2, 3), new Cmp(4, 5), new Cmp(10, 11), new Cmp(12, 13));
    ...
    private static final Comparison COMPARISON_16_8 =
            createComparison(SPECIES_16, new Cmp(4, 6), new Cmp(5, 7), new Cmp(9, 11), new Cmp(10, 12));
    ...
    private static final Comparison COMPARISON_16_9 =
            createComparison(SPECIES_16, new Cmp(3, 4), new Cmp(5, 6), new Cmp(7, 8), new Cmp(9, 10), new Cmp(11, 12));
    ...
    private static final Comparison COMPARISON_16_10 = createComparison(SPECIES_16, new Cmp(6, 7), new Cmp(8, 9));
    ...
    private static IntVector compareAndExchange(
            IntVector vector, VectorShuffle<Integer> shuffle, VectorMask<Integer> mask) {
    ...
    private static Comparison createComparison(VectorSpecies<Integer> species, Cmp... wires) {
        ...
        for (Cmp comparison : wires) {
            ...
            mask[comparison.left] = false;
            mask[comparison.right] = true;
        }
